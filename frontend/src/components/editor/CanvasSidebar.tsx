...
export function CanvasSidebar({
  ...
  return (
    <aside className="w-[88px] bg-[#0A0A0A] border-r border-[rgba(255, 255, 255, 0.2)] p-5 flex flex-col justify-between shrink-0">
      <div className="space-y-6">
        <div>
          <div className="text-[11px] font-bold text-slate-400 tracking-wider uppercase mb-3 flex items-center gap-1.5">
            <Compass className="w-3.5 h-3.5 text-[#5BADFF]" /> Add Components
          </div>
          <div className="space-y-1.5">
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-slate-300 hover:bg-[#383838] text-xs font-medium transition-all text-left"
            >
              <Link2 className="w-4 h-4 text-[#5BADFF]" /> Link Zone
            </button>
          </div>
        </div>
        ...
        <div className="pt-4 border-t border-[rgba(255, 255, 255, 0.2)]">
          ...
          <label className="flex items-center justify-center gap-2 w-full p-2.5 border-2 border-dashed border-[#444] hover:border-[#0d99ff] rounded-xl bg-[#222] cursor-pointer text-xs font-semibold text-slate-300 transition-all">
            <Upload className="w-3.5 h-3.5 text-[#5BADFF]" /> Upload Font
            (.ttf/.woff)
            <input
              type="file"
      ...
      <button
        ...
        className="w-full bg-[#5BADFF] hover:bg-[#4a9cee] text-white font-semibold py-3 px-4 rounded-xl shadow-sm flex items-center justify-center gap-2 text-xs transition-all"
      >
